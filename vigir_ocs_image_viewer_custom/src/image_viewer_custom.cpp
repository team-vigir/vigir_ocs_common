/*
 * ImageViewerCustom class implementation.
 * 
 * Author: Felipe Bacim.
 * 
...
// Constructor for ImageViewerCustom.  This does most of the work of the class.
ImageViewerCustom::ImageViewerCustom( QWidget* parent )
  : QWidget( parent )
{
...
void ImageViewerCustom::select( int x1, int y1, int x2, int y2 )
{
  ((rviz::ImageDisplayCustom*)camera_viewer_)->selectionProcessed( x1, y1, x2, y2 );
}


void ImageViewerCustom::changeCameraTopic( int t )
{
...
void ImageViewerCustom::changeCropImageResolution( int t )
{
    Q_EMIT setCropImageResolution( t );
}


void ImageViewerCustom::changeCameraSpeed( int t )
{
