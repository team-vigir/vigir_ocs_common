...
void BaseContextMenu::createContextMenuItems()
{
    ...
    context_menu_manager_->addActionItem("Unlock Arms", boost::bind(&Base3DView::setTemplateGraspLock, base_3d_view_, flor_ocs_msgs::OCSObjectSelection::UNLOCK_ARMS), NULL);
