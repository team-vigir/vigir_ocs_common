    ...
    , circular_marker_(0)
{
    ...
    QObject::connect(mouse_event_handler_, SIGNAL(mouseRightButton(bool,int,int)), base_context_menu_, SLOT(createContextMenu(bool,int,int)));
...
//void Base3DView::addToContextMenuFromVector()s
//{
