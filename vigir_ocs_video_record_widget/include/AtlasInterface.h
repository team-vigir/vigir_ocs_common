...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	//!
	//! \brief  Create an object for interfacing to the Atlas robot.
	//!
	//! \_Description
	//!
	//!    Do not create more than one AtlasInterface object!
	//!
	AtlasInterface();
...
///@{
	...
	///////////////////////////////////////////////////////
	//!
	//! \brief  Clear fault status flags.
	//!
	//! \_Description
	//!
	//!    <em> This functionality is not yet implemented. </em>
	//!
	//!    This function lowers any raised fault flags present in the robot's
	//!    AtlasControlDataFromRobot state.
	//!
	//!    This function will only clear critical faults if called in the Idle
	//!    state.
	//!
	//!    clear_faults() is a command function.  See start() about
	//!    limitations of running two command functions at the same time.
	//!
	//! \_Returns
	//!
	...
	//!    \li   ERROR_ILLEGAL_ARGUMENT
	//!
	AtlasErrorCode clear_faults(int64_t* packet_seq_id);
	...
	//!
	//!    The filename of the log file will be generated automatically, based
	//!    robot IP address or hostname, and date and time of download.
	//!
	//! \_Returns
	//!
	//!    Possible return values:
...
///@{
	...
	///////////////////////////////////////////////////////
	//!
	//! \brief  Calibrate wrist sensors
	//!
	//! \_Description
	//!
	//!    This function performs calibration exercises for the wrists.
	//!
	...
	//!    \li   ERROR_ILLEGAL_ARGUMENT
	//!
	AtlasErrorCode calibrate_wrists(int64_t* packet_seq_id);


	///////////////////////////////////////////////////////
	//!
	//! \brief  Calibrate ankle sensors
	//!
	//! \_Description
	//!
	//!    This function performs calibration exercises for the ankles.
	//!
	//!    This is a command function.  See start() about limitations of
	//!    running two command functions at the same time.
	//!
	...
	//!    \li   ERROR_ILLEGAL_ARGUMENT
	//!
	AtlasErrorCode calibrate_ankles(int64_t* packet_seq_id);
...
///@{
	...
	//!
	std::string get_run_state_as_string(AtlasRobotRunState run_state);
	...
	//!
	std::string get_status_flag_as_string(AtlasRobotStatus robot_status_flag);
	...
	//!
	std::string link_name_from_link_id(AtlasLinkId link_id);
	...
	//!
	AtlasLinkId link_id_from_link_name(std::string link_name);
	...
	//!
	std::string joint_name_from_joint_id(AtlasJointId joint_id);
	...
	//!
	AtlasJointId joint_id_from_joint_name(std::string joint_name);
	...
	//!
	std::string behavior_name_from_behavior(AtlasRobotBehavior behavior);
	...
	//!
	AtlasRobotBehavior behavior_from_behavior_name(std::string behavior_name);
