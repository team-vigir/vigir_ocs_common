...
{
    interactive_marker_server_feedback_pub_ = nh_.advertise<flor_ocs_msgs::OCSInteractiveMarkerUpdate>( "/flor/ocs/interactive_marker_server/feedback", 1, false );
    ...
    interactive_marker_server_mode_sub_ = nh_.subscribe<std_msgs::Int8>( "/flor/ocs/interactive_marker_server/set_mode", 5, &InteractiveMarkerServerNodelet::setMode, this );
}
...
void InteractiveMarkerServerNodelet::setMode(const std_msgs::Int8::ConstPtr &msg)
{
